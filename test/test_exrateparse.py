...
class ExchRateTestKnownValues(unittest.TestCase):
    known_values = (
        ...
        (
            ...
            [15.757965, 15.767906, 15.77124, 15.776095],
        ),  # USD rate date range
    )
...
class ExchRateTestException(unittest.TestCase):
    ...
    def test_unknown_source(self):
        self.assertRaises(
            exrateparse.UnknownSourceError,
            exrateparser,
            'N/A',
            '2002-01-01',
            'USD',
